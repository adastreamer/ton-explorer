...
query = "select at, header, content, LOCATE('"..q.."',content) as i, CHAR_LENGTH(content) as len from ton.blocks where MATCH(content) AGAINST ('"..q.."') LIMIT "..limit.." OFFSET "..(page * limit)..";"
